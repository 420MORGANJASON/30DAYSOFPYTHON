...
def weatherApp(temperature, raining):
    ...
    if temperature < 50:
        print("I suggest you wear a coat, hat, scarf and gloves")
    elif temperature > 50 and temperature < 70 and raining == 0:
        print("I suggest you wear a sweater or light jacket.")
    elif temperature > 50 and temperature < 70 and raining == 1:
        print("I suggest you wear a  a rain jacket and boots.")
    elif temperature > 70 and raining == 0:
        print("I suggest you wear a t-shirt and shorts.")
    elif temperature > 70 and raining == 1:
        print("I suggest you wear a light jacket and rain boots.")
